...
- [obra/superpowers](https://github.com/obra/superpowers) `⭐255.7k · 2026-07-16` — A full skill kit for coding agents: brainstorming, TDD, systematic debugging and more.
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) `⭐151.7k · 2026-07-16` — Crawls entire sites into LLM-ready Markdown/structured data, with an API.
...
- [microsoft/playwright](https://github.com/microsoft/playwright) `⭐92.9k · 2026-07-16` — The standard for browser automation; dynamic-page scraping and E2E testing alike.
...
- [shadcn-ui/ui](https://github.com/shadcn-ui/ui) `⭐119.2k · 2026-07-16` — Copy-paste component collection; the de facto standard for AI-generated React UIs.
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) `⭐96k · 2026-07-15` — Utility-first CSS; the AI's first choice for styling, with the most training data.
...
- [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) `⭐64k · 2026-07-04` — Gives your AI good taste; stops it from generating boring, generic slop.
...
- [emilkowalski/skills · apple-design](https://github.com/emilkowalski/skills/blob/main/skills/apple-design/SKILL.md) `⭐14k · 2026-07-15` — Apple-design skill by design engineer Emil Kowalski (of sonner/vaul); teaches the AI Apple-grade motion and detail.
...
- [nuxt/nuxt](https://github.com/nuxt/nuxt) `⭐60.8k · 2026-07-15` — The Vue full-stack framework; Vue's answer to Next.js.
- [prisma/prisma](https://github.com/prisma/prisma) `⭐47.4k · 2026-07-14` — TypeScript ORM; a type-safe database access layer.
...
- [coollabsio/coolify](https://github.com/coollabsio/coolify) `⭐58.7k · 2026-07-15` — Self-hosted Vercel/Heroku alternative; apps running in a few clicks.
...
- [triggerdotdev/trigger.dev](https://github.com/triggerdotdev/trigger.dev) `⭐15.7k · 2026-07-15` — Code-first background jobs and workflow framework.
...
- [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut) `⭐73.2k · 2026-07-10` — Open-source web video editor; the CapCut alternative.
...
- [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) `⭐35.1k · 2026-07-15` — Official Playwright MCP; let the AI drive a browser directly.
- [github/github-mcp-server](https://github.com/github/github-mcp-server) `⭐31.5k · 2026-07-15` — GitHub's official MCP; let the AI manage repos, issues, PRs.
