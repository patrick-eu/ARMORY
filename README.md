...
- [anthropics/claude-code](https://github.com/anthropics/claude-code) `⭐138.1k · 2026-07-15` — 终端里的 AI 编程 Agent，理解整个代码库，执行多步任务。
- [cline/cline](https://github.com/cline/cline) `⭐64.7k · 2026-07-16` — VS Code 里的自主编程 Agent，能创建/编辑文件、跑命令、用浏览器。
- [All-Hands-AI/OpenHands](https://github.com/All-Hands-AI/OpenHands) `⭐81k · 2026-07-16` — 开源 AI 软件工程师平台，能完成完整开发任务。
- [Aider-AI/aider](https://github.com/Aider-AI/aider) `⭐47.4k · 2026-05-22` — 终端结对编程工具，直接在本地 git 仓库上改代码。
- [continuedev/continue](https://github.com/continuedev/continue) `⭐34.9k · 2026-07-16` — 开源 IDE 助手，可自定义模型和上下文源。
- [RooCodeInc/Roo-Code](https://github.com/RooCodeInc/Roo-Code) `⭐24.3k · 2026-05-15` — Cline 的社区增强分支，多模式 Agent 团队。
- [openai/codex](https://github.com/openai/codex) `⭐98.7k · 2026-07-16` — OpenAI 的终端编程 Agent，Rust 实现，轻量快速。
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) `⭐106k · 2026-07-16` — Google 开源的终端 AI Agent，直连 Gemini。
- [anomalyco/opencode](https://github.com/anomalyco/opencode) `⭐186.4k · 2026-07-16` — 开源终端 AI 编程 Agent，模型随便换。
- [aaif-goose/goose](https://github.com/aaif-goose/goose) `⭐51.3k · 2026-07-16` — 本地运行的开源 AI Agent，可装扩展自动化工程任务。
- [TabbyML/tabby](https://github.com/TabbyML/tabby) `⭐33.7k · 2026-06-30` — 自托管 AI 代码补全，Copilot 的开源替代。
- [Kilo-Org/kilocode](https://github.com/Kilo-Org/kilocode) `⭐26.3k · 2026-07-16` — VS Code 开源 AI Agent，集 Cline/Roo 之长。
...
- [ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) `⭐8.5k · 2026-07-16` — 精选高分 GPTs 提示词与提示词工程资料。

## 📚 让 AI 读懂代码与文档

把仓库、网页、文档转成 AI 能吃的上下文。

- [coderamp-labs/gitingest](https://github.com/coderamp-labs/gitingest) `⭐15.1k · 2026-07-14` — 把任意 Git 仓库一键变成适合喂给 LLM 的纯文本摘要。
- [upstash/context7](https://github.com/upstash/context7) `⭐59.2k · 2026-07-13` — MCP 服务器，让 AI 实时获取库的最新官方文档和示例代码。
- [AsyncFuncAI/deepwiki-open](https://github.com/AsyncFuncAI/deepwiki-open) `⭐17.3k · 2026-06-03` — 给任意仓库自动生成 Wiki 文档，帮 AI 和人快速理解项目。
- [yamadashy/repomix](https://github.com/yamadashy/repomix) `⭐27.2k · 2026-07-15` — 把整个代码库打包成一份 AI 友好的文件，gitingest 的热门同类。
- [microsoft/markitdown](https://github.com/microsoft/markitdown) `⭐166.5k · 2026-06-24` — 微软出品，Office/PDF 等各种文件转 Markdown 喂 LLM。
- [docling-project/docling](https://github.com/docling-project/docling) `⭐63.3k · 2026-07-15` — IBM 开源文档解析器，PDF/表格/版面理解，输出结构化数据。
- [opendatalab/MinerU](https://github.com/opendatalab/MinerU) `⭐74.8k · 2026-07-15` — 高质量 PDF 转 Markdown/JSON，公式表格都能抽。
- [datalab-to/marker](https://github.com/datalab-to/marker) `⭐37.5k · 2026-07-07` — PDF 快速精准转 Markdown，公式表格支持好。
- [jina-ai/reader](https://github.com/jina-ai/reader) `⭐11.6k · 2026-05-22` — 任意 URL 前加 r.jina.ai 即得 LLM 友好的正文文本。
- [Unstructured-IO/unstructured](https://github.com/Unstructured-IO/unstructured) `⭐15.1k · 2026-07-15` — 各种格式文档的 ETL 预处理库，RAG 数据管道常客。
...
- [getmaxun/maxun](https://github.com/getmaxun/maxun) `⭐16.5k · 2026-07-15` — 开源无代码平台，训练机器人把网页变成 API/表格。
- [puppeteer/puppeteer](https://github.com/puppeteer/puppeteer) `⭐95.5k · 2026-07-16` — Chrome 官方无头浏览器自动化库。
- [SeleniumHQ/selenium](https://github.com/SeleniumHQ/selenium) `⭐34.3k · 2026-07-16` — 浏览器自动化元老，跨浏览器兼容性最好。
...
- [fastapi/fastapi](https://github.com/fastapi/fastapi) `⭐100.6k · 2026-07-16` — Python 高性能 API 框架，类型驱动，AI 生成的代码质量高。
- [nestjs/nest](https://github.com/nestjs/nest) `⭐76.3k · 2026-07-16` — Node.js 企业级后端框架，结构清晰适合 AI 遵循。
- [supabase/supabase](https://github.com/supabase/supabase) `⭐106.5k · 2026-07-16` — 开源 Firebase 替代品，数据库+认证+存储一条龙。
- [vercel/next.js](https://github.com/vercel/next.js) `⭐141.1k · 2026-07-16` — React 全栈框架，AI 最熟悉的前端框架之一。
- [django/django](https://github.com/django/django) `⭐88.2k · 2026-07-15` — Python 全家桶式 Web 框架，自带 Admin/ORM，AI 语料极多。
...
- [pytest-dev/pytest](https://github.com/pytest-dev/pytest) `⭐14.3k · 2026-07-14` — Python 测试框架事实标准，插件生态庞大。
- [vitest-dev/vitest](https://github.com/vitest-dev/vitest) `⭐16.8k · 2026-07-16` — Vite 原生测试框架，前端项目开箱即用。
- [jestjs/jest](https://github.com/jestjs/jest) `⭐45.5k · 2026-07-15` — 经典 JS 测试框架，语料最多，AI 最熟。
- [cypress-io/cypress](https://github.com/cypress-io/cypress) `⭐50.7k · 2026-07-16` — 端到端测试框架，在真实浏览器里跑用户流程。
- [astral-sh/ruff](https://github.com/astral-sh/ruff) `⭐48.6k · 2026-07-16` — 极快的 Python linter + 格式化器，AI 生成的代码先过一遍。
- [biomejs/biome](https://github.com/biomejs/biome) `⭐25.4k · 2026-07-16` — JS/TS 一体化 lint + 格式化，Prettier/ESLint 二合一替代。
- [The-PR-Agent/pr-agent](https://github.com/The-PR-Agent/pr-agent) `⭐12.1k · 2026-07-10` — AI 自动 code review，在 PR 里直接给改进建议。
- [faker-js/faker](https://github.com/faker-js/faker) `⭐15.4k · 2026-07-16` — 批量生成逼真的测试数据。
- [locustio/locust](https://github.com/locustio/locust) `⭐28k · 2026-07-14` — 用 Python 脚本写场景的压测工具。
- [stryker-mutator/stryker-js](https://github.com/stryker-mutator/stryker-js) `⭐2.9k · 2026-07-15` — 变异测试，检验你的测试是不是真能抓住 bug。
...
- [docker/compose](https://github.com/docker/compose) `⭐37.8k · 2026-07-16` — 多容器应用编排的标准件。
- [traefik/traefik](https://github.com/traefik/traefik) `⭐64k · 2026-07-16` — 云原生反向代理，服务发现全自动。
- [portainer/portainer](https://github.com/portainer/portainer) `⭐38k · 2026-07-15` — Docker/K8s 图形化管理面板。
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) `⭐14.9k · 2026-07-15` — Cloudflare Tunnel 客户端，把内网服务安全暴露到公网。
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) `⭐89.2k · 2026-07-16` — 自托管可用性监控，服务挂了立刻知道。
- [getsentry/sentry](https://github.com/getsentry/sentry) `⭐44.3k · 2026-07-16` — 错误追踪与性能监控，上线后第一时间发现问题。
...
- [browser-use/video-use](https://github.com/browser-use/video-use) `⭐17k · 2026-07-01` — 用编程 Agent 剪视频，视频界的 browser-use。
...
- [ManimCommunity/manim](https://github.com/ManimCommunity/manim) `⭐39.5k · 2026-07-14` — 3Blue1Brown 同款数学动画引擎，做讲解视频的利器。
- [mifi/lossless-cut](https://github.com/mifi/lossless-cut) `⭐42.1k · 2026-07-14` — 无损快速剪切视频，不重新编码秒级出片。

## 🔌 MCP 与 Agent 生态

给 AI 装外挂的基础设施。

- [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) `⭐88.5k · 2026-07-10` — MCP 官方服务器合集，文件系统、数据库、搜索等能力即插即用。
...
- [browserbase/stagehand](https://github.com/browserbase/stagehand) `⭐23.5k · 2026-07-16` — AI 浏览器自动化框架，自然语言与代码混合控制。
- [openai/openai-agents-python](https://github.com/openai/openai-agents-python) `⭐27.9k · 2026-07-16` — OpenAI 官方多 Agent 编排 SDK。
- [google/adk-python](https://github.com/google/adk-python) `⭐20.6k · 2026-07-16` — Google 的 Agent 开发套件（ADK）。
